...
public class MusicOrgTest {
  ...
  public void MusicOrg_instatiatesCorrectly_true() {
    MusicOrg newMusic = new MusicOrg("Album Name", "Artist Name");
  ...
  public void all_returnsAllInstancesOfMusicOrg_true() {
    MusicOrg firstAlbum = new MusicOrg("Album 1", "Artist 1");
    MusicOrg secondAlbum = new MusicOrg("Album 2", "Artist 2");
